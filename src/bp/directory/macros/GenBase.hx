...
class GenBase {
  public function new() {}
  public function nullable(e:Type):Type return throw 'abstract';
  public function string():Type return throw 'abstract';
  public function float():Type return throw 'abstract';
  public function int():Type return throw 'abstract';
  public function dyn(e:Type, ct:ComplexType):Type return throw 'abstract';
  public function dynAccess(e:Type):Type return throw 'abstract';
  public function bool():Type return throw 'abstract';
  public function date():Type return throw 'abstract';
  public function bytes():Type return throw 'abstract';
  public function anon(fields:Array<FieldInfo<Type>>, ct:ComplexType):Type return throw 'abstract';
  public function array(e:Type):Type return throw 'abstract';
